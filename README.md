...
I’m a *Cloud Engineer* and *AI Practitioner* with a passion for harnessing the power of cloud computing and artificial intelligence to solve complex challenges. Whether I’m architecting secure systems or building AI-powered tools, I thrive on collaboration, innovation, and continuous learning. When I'm off the clock, you'll find me lost in a good book, scribbling new ideas, or exploring creative digital art.
...
A snapshot of the tools that fuel my projects:
...
Here are a few highlights of my work, where creativity meets cutting-edge tech:
...
- **[High Availability and Security for PHP Applications](https://github.com/Salma22C/awsprojects/tree/main/High%20Availability%20and%20Security%20for%20PHP%20Applications%20)**  
  *Crafted a resilient and secure AWS architecture for PHP apps that ensures high availability and robust security.*

- **[Text Summarization Tool](https://github.com/Salma22C/AIprojects/blob/main/Text%20Summarization%20Tool/%20textsumm.py)**  
  *Built an AI-driven summarization tool that distills lengthy documents into clear, concise insights using advanced NLP techniques.*
...
- [Other Repositories](https://github.com/Salma22C?tab=repositories)
